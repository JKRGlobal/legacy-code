...
#  Created by Stephen Warneford-Bygrave on 2016-02-08
...
cp -r "/Volumes/.Software/Mac/Extensis/Universal Type Client/Current/6.0.0/1 Installer/Universal Type Client 6.0.1.pkg" /var/folders/deploy/
cp -r "/Volumes/.Software/Mac/Extensis/Universal Type Client/Current/6.0.0/5 Miscellaneous/UT-Client-removal-tool-v6.0.0.command" /var/folders/deploy/
...
installer -pkg "/var/folders/deploy/Universal Type Client 6.0.1.pkg" -target /
