...
#  Install-LDN-Adobe_Media_Encoder_CC_2014_UK.sh
#
#
...
cp -r /Volumes/.Software/Mac/Adobe/Media\ Encoder/Current/CC\ 2014/1\ Installer/Adobe\ Media\ Encoder\ CC\ 2014_Install.pkg /var/folders/deploy/
...
installer -pkg /var/folders/deploy/Adobe\ Media\ Encoder\ CC\ 2014_Install.pkg -target /
