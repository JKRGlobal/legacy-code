...
#  Install-LDN-Microsoft_Office_2011_365.sh
#
#
...
cp -r /Volumes/.Software/Mac/Microsoft/Microsoft\ Office/Current/2011\ 365/3\ Updates/Microsoft\ Office\ 2011\ 14.4.7\ Update.pkg /var/folders/deploy/
