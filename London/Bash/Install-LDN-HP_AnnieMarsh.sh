...
lpadmin -x "jkr_hr"
lpadmin -x "hr_printer"
lpadmin -x "HP_AnnieMarsh"
lpadmin -x "HP_HR"
lpadmin -x "HP-AnnieMarsh"
...
lpadmin -p "HP_AnnieMarsh" -v lpd://192.168.211.13/ -D "HP_AnnieMarsh" -E -P "$ppdloc/HP Laserjet P2055d.gz" -o printer-is-shared=false -o HPOption_Duplexer=True -o Duplex=DuplexNoTumble 
