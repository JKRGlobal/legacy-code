...
#  Install-LDN-Adobe_CS5_5_Standard_UK.sh
...
cp -r /Volumes/.Software/Mac/Adobe/Creative\ Suite/Current/CS5.5/1\ Installer/Adobe\ CS5.5\ Standard\ UK.pkg /var/folders/deploy/
...
# Install Application
installer -pkg /var/folders/deploy/Adobe\ CS5.5\ Standard\ UK.pkg -target /
