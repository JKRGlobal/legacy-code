...
#  Install-LDN-Adobe_After_Effects_CC_2014_UK.sh
#
#
#  Created by Stephen Warneford-Bygrave on 12/08/2015.
...
cp -r /Volumes/.Software/Mac/Adobe/After\ Effects/Current/CC\ 2014/1\ Installer/Adobe\ After\ Effects\ CC\ 2014\ UK_Install.pkg /var/folders/deploy/
...
installer -pkg /var/folders/deploy/Adobe\ After\ Effects\ CC\ 2014\ UK_Install.pkg -target /
...
# 12/08/15  v1.0.1  Stephen Bygrave		Initial release