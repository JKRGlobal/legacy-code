...
#  Install-NYC-Adobe_Premiere_Pro_CC_2014.sh
#
#
...
cp -r /Volumes/.Software/Mac/Adobe/Creative\ Cloud/Current/Premier\ 2014/Adobe\ Premier\ CC\ 2014_Install.pkg /var/folders/deploy/

# Install Blue Jeans

installer -pkg /var/folders/deploy/Adobe\ Premier\ CC\ 2014_Install.pkg -target /
