...
#  Install-SNG-FastTrack_9.sh
#  Created by Stephen Warneford-Bygrave on 2016-04-20
...
# Install Application
hdiutil attach "/Volumes/.Software/Mac/AEC/FastTrack/Current/9/1 Installer/FastTrack Schedule 9-9.0.dmg" -mountpoint "$TMP_MOUNT"
installer -pkg "$TMP_MOUNT/FastTrack Schedule 9.pkg" -target /
