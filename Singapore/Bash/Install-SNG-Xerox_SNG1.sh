...
if [[ ! -f "/Library/Printers/PPDs/Contents/Resources/FX DocuCentre-V C5585 PS.gz" ]]; then
...
lpadmin -x "Xerox_SN"
lpadmin -x "Xerox_SNG"
lpadmin -x "Xerox_SNG1"

# Configure printers using lpd
lpadmin -p "Xerox_SNG1" -v lpd://192.168.10.210 -D "Xerox_SNG1" -E -P "/Library/Printers/PPDs/Contents/Resources/FX DocuCentre-V C5585 PS.gz" -o printer-is-shared=false
echo "Xerox_SNG1 installed. Terminating..."
exit 0
