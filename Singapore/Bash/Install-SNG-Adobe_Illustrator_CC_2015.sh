...
#  Install-SNG-Adobe_Illustrator_CC_2015.sh
...
installer -pkg "$TMP_MOUNT/Adobe Illustrator CC 2015/Build/Adobe Illustrator CC 2015_Install.pkg" -target /
installer -pkg "$TMP_MOUNT/Adobe Illustrator CC 2015 Update/Build/Adobe Illustrator CC 2015 Update_Install.pkg" -target /
