...
#  Install-SNG-Adobe_Premiere_Pro_CC_2015.sh
...
installer -pkg "$TMP_MOUNT/Adobe Premiere Pro CC 2015/Build/Adobe Premiere Pro CC 2015_Install.pkg" -target /
installer -pkg "$TMP_MOUNT/Adobe Premiere Pro CC 2015 Update/Build/Adobe Premiere Pro CC 2015 Update_Install.pkg" -target /
