...
#  Install-SNG-Adobe_InDesign_CC_2015.sh
...
installer -pkg "$TMP_MOUNT/Adobe InDesign CC 2015/Build/Adobe InDesign CC 2015_Install.pkg" -target /
installer -pkg "$TMP_MOUNT/Adobe InDesign CC 2015 Update/Build/Adobe InDesign CC 2015 Update_Install.pkg" -target /
